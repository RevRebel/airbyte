...
import pytest
from source_clickup.source import ClickupStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ClickupStream, "path", "v0/example_endpoint")
    mocker.patch.object(ClickupStream, "primary_key", "test_primary_key")
    mocker.patch.object(ClickupStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ClickupStream()
