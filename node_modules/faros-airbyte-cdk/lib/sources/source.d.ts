 ...
 */
export declare abstract class AirbyteSource extends AirbyteConnector {
    /**
     ...
     */
    abstract discover(config: AirbyteConfig): Promise<AirbyteCatalogMessage>;
    /**
     * @returns A generator of the AirbyteMessages generated by reading the source
     * with the given configuration, catalog, and state.
     */
    abstract read(config: AirbyteConfig, catalog: AirbyteConfiguredCatalog, state?: AirbyteState): AsyncGenerator<AirbyteMessage>;
}
